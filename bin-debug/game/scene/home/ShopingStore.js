 ...
 */
var ShopingStore = (function (_super) {
    __extends(ShopingStore, _super);
    function ShopingStore() {
    ...
    ShopingStore.prototype.onAddToStage = function (event) {
    ...
    ShopingStore.prototype.drawSomething = function () {
